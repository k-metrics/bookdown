...
{\centering \subfloat[花弁の回帰モデル\label{fig:unnamed-chunk-8-1}]{\includegraphics[width=0.5\linewidth,]{R_files/figure-latex/unnamed-chunk-8-1} }\subfloat[萼片の回帰モデル（参考）\label{fig:unnamed-chunk-8-2}]{\includegraphics[width=0.5\linewidth,]{R_files/figure-latex/unnamed-chunk-8-2} }
...
　比例尺度は間隔尺度と同様に整数型（\texttt{integer}）や実数型（\texttt{numeric}）のデータ型を用います。データの作成方法は間隔尺度と同じですので省略します。
...
　データ型は扱うデータの尺度水準に応じたものを使うようにすると便利です。\textbf{R}を使いこなしていくうちに自然と理解できると思いますが、因子型変数は文字型変数にはない利点があります。
...
\addcontentsline{toc}{subsubsection}{算術平均}
...
\addcontentsline{toc}{subsubsection}{トリム平均}
...
\addcontentsline{toc}{subsubsection}{幾何平均}
...
\addcontentsline{toc}{subsubsection}{歪度}
...
{\centering \includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-45-1} 
...
{\centering \includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-47-1} 
...
\addcontentsline{toc}{subsubsection}{尖度}

　尖度はデータ分布の尖り具合です。標準正規分布と等しければ\(0\)、標準正規分布より尖ったt分布のような分布では正の値、広がった分布であれば負の値をとります。

\begin{figure}[H]

{\centering \includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-49-1} 
...
{\centering \includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-51-1} 
...
{\centering \includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-53-1} 
...
\caption{Google Colab, Theme: dark}\label{fig:unnamed-chunk-136}
\end{figure}
...
\caption{Upload notebook file}\label{fig:unnamed-chunk-137}
\end{figure}
...
\caption{Upload from GitHub}\label{fig:unnamed-chunk-138}
\end{figure}
...
\caption{Warning dialog}\label{fig:unnamed-chunk-139}
\end{figure}
...
\caption{RStudio Cloud, beta}\label{fig:unnamed-chunk-140}
\end{figure}
...
\caption{Initial View}\label{fig:unnamed-chunk-141}
\end{figure}
...
\caption{Packages Manager}\label{fig:unnamed-chunk-142}
\end{figure}
...
\caption{Install Dialog}\label{fig:unnamed-chunk-143}
\end{figure}
...
\caption{RStudio Desktop, Windows}\label{fig:unnamed-chunk-151}
\end{figure}
...
\caption{RStudio Pane Layout, Windows}\label{fig:unnamed-chunk-152}
\end{figure}
...
\caption{R Notebook file}\label{fig:unnamed-chunk-153}
\end{figure}
...
\caption{R Notebook saved file}\label{fig:unnamed-chunk-154}
\end{figure}
...
\caption{R Notebook insert chunk}\label{fig:unnamed-chunk-155}
\end{figure}
...
\caption{R Notebook first code}\label{fig:unnamed-chunk-156}
\end{figure}
...
\caption{R Notebook run code}\label{fig:unnamed-chunk-157}
\end{figure}
...
\caption{R Notebook option}\label{fig:unnamed-chunk-158}
\end{figure}
...
\caption{RStudio Cloud, beta}\label{fig:unnamed-chunk-159}
\end{figure}
...
\caption{Exploratory Public}\label{fig:unnamed-chunk-160}
\end{figure}
