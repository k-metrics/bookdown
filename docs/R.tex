...
## 7 virginica  Sepal.Width     3
## 8 virginica Petal.Length   5.1
## 9 virginica  Petal.Width   1.8
\end{verbatim}

変形したデータを使って部位別の箱ひげ図を描くと確かに Petal（花弁）の方が Sepal（萼片）よりも小さい傾向にあることが分かります。

\begin{center}\includegraphics[width=0.9\linewidth]{R_files/figure-latex/unnamed-chunk-5-1} \end{center}
