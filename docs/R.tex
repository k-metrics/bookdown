...
\else % if luatex or xetex
  ...
  \setmainfont[Scale=MatchUppercase]{NotoSerifCJKjp-Regular.otf}
  \setsansfont[]{NotoSansCJKjp-Regular.otf}
  \setmonofont[]{NotoSansMonoCJKjp-Regular.otf}
  \ifxetex
    \usepackage{xeCJK}
    \setCJKmainfont[Scale=1]{NotoSerifCJKjp-Regular.otf}
  \fi
  \ifluatex
    \usepackage[]{luatexja-fontspec}
    \setmainjfont[Scale=1]{NotoSerifCJKjp-Regular.otf}
  \fi
\fi
...
\begin{center}\includegraphics{R_files/figure-latex/unnamed-chunk-2-1} \end{center}
...
{\centering \includegraphics[width=0.95\linewidth]{fig/data-science} 
