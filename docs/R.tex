...
\caption{\label{tab:unnamed-chunk-74}irisデータセットの要約統計量}
\centering
...
\caption{Google Colab, Theme: dark}\label{fig:unnamed-chunk-140}
\end{figure}
...
\caption{Upload notebook file}\label{fig:unnamed-chunk-141}
\end{figure}
...
\caption{Upload from GitHub}\label{fig:unnamed-chunk-142}
\end{figure}
...
\caption{Warning dialog}\label{fig:unnamed-chunk-143}
\end{figure}
...
\caption{RStudio Cloud, beta}\label{fig:unnamed-chunk-144}
\end{figure}
...
\caption{Initial View}\label{fig:unnamed-chunk-145}
\end{figure}
...
\caption{Packages Manager}\label{fig:unnamed-chunk-146}
\end{figure}
...
\caption{Install Dialog}\label{fig:unnamed-chunk-147}
\end{figure}
...
\caption{RStudio Desktop, Windows}\label{fig:unnamed-chunk-155}
\end{figure}
...
\caption{RStudio Pane Layout, Windows}\label{fig:unnamed-chunk-156}
\end{figure}
...
\caption{R Notebook file}\label{fig:unnamed-chunk-157}
\end{figure}
...
\caption{R Notebook saved file}\label{fig:unnamed-chunk-158}
\end{figure}
...
\caption{R Notebook insert chunk}\label{fig:unnamed-chunk-159}
\end{figure}
...
\caption{R Notebook first code}\label{fig:unnamed-chunk-160}
\end{figure}
...
\caption{R Notebook run code}\label{fig:unnamed-chunk-161}
\end{figure}
...
\caption{R Notebook option}\label{fig:unnamed-chunk-162}
\end{figure}
...
\caption{RStudio Cloud, beta}\label{fig:unnamed-chunk-163}
\end{figure}
...
\caption{Exploratory Public}\label{fig:unnamed-chunk-164}
\end{figure}
