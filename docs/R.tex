...
下位・上位をある割合で除いて平均（算術平均）を求めるトリム平均もあります。トリム平均は異常値や外れ値がある場合にそれらの影響を排除して平均を求めたい場合に利用されます。刈込み平均や調整平均とも呼ばれます。 体操競技などで極端な点数を出す審査員の影響を排除するために使われています。比較的多いのが全員の得点から最小値と最大値を除いたものから平均値を求め、その平均値を得点する方法です。

平均といってもこのように様々な求め方があります。では、\textbf{R}を使ってこれらの平均を求めてみます。
...
\begin{center}\includegraphics[width=0.85\linewidth,]{R_files/figure-latex/unnamed-chunk-34-1} \end{center}
...
\begin{center}\includegraphics[width=0.85\linewidth,]{R_files/figure-latex/unnamed-chunk-36-1} \end{center}
...
\begin{center}\includegraphics[width=0.85\linewidth,]{R_files/figure-latex/unnamed-chunk-38-1} \end{center}
...
\begin{center}\includegraphics[width=0.85\linewidth,]{R_files/figure-latex/unnamed-chunk-40-1} \end{center}
...
\begin{center}\includegraphics[width=0.85\linewidth,]{R_files/figure-latex/unnamed-chunk-42-1} \end{center}
...
\begin{center}\includegraphics[width=0.85\linewidth,]{R_files/figure-latex/unnamed-chunk-44-1} \end{center}
...
標本分散（\(s^2\)）と不偏分散（\(\hat{\sigma}^2\)）の関係式\eqref{eq:variance-var}を用いて\textbf{R}で以下の二つのデータの標本分散（\(s^2\)）を求めなさい。
...
　推定統計量を表記する場合、推定であることを意味するハット（ \(\hat{}\) ）という記号をつけます。\\
　平均と分散・標準偏差を使って整理すると下表のようになります。
