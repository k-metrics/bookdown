...
{\centering \includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-5-1} 
...
{\centering \subfloat[花弁\label{fig:unnamed-chunk-6-1}]{\includegraphics[width=0.5\linewidth,]{R_files/figure-latex/unnamed-chunk-6-1} }\subfloat[萼片\label{fig:unnamed-chunk-6-2}]{\includegraphics[width=0.5\linewidth,]{R_files/figure-latex/unnamed-chunk-6-2} }
...
{\centering \subfloat[花弁の回帰モデル\label{fig:unnamed-chunk-9-1}]{\includegraphics[width=0.5\linewidth,]{R_files/figure-latex/unnamed-chunk-9-1} }\subfloat[萼片の回帰モデル（参考）\label{fig:unnamed-chunk-9-2}]{\includegraphics[width=0.5\linewidth,]{R_files/figure-latex/unnamed-chunk-9-2} }
...
\caption{Rcmdr on Ubuntu(Linux)}\label{fig:unnamed-chunk-15}
\end{figure}
...
\caption{RStudio Desktop on Windows}\label{fig:unnamed-chunk-17}
\end{figure}
...
\caption{RStudio Server, Docker Container}\label{fig:unnamed-chunk-18}
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-44-1} 

}

\caption{正規分布に近い分布}\label{fig:unnamed-chunk-44}
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-46-1} 

}

\caption{右に歪んだ分布（左に偏った分布）}\label{fig:unnamed-chunk-46}
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-48-1} 

}

\caption{左に歪んだ分布（右に偏った分布）}\label{fig:unnamed-chunk-48}
\end{figure}
...
\caption{中心部が高く幅の狭い尖った分布}\label{fig:unnamed-chunk-52}
\end{figure}
...
\caption{中心部が低く横に広がった分布}\label{fig:unnamed-chunk-54}
\end{figure}
...
　\texttt{iris}データセットの主な要約統計量をまとめると下表のようになります。このように最頻値は常にひとつとは限りません。

\begin{table}[H]

\caption{\label{tab:unnamed-chunk-75}irisデータセットの要約統計量}
\centering
...
\hypertarget{ux8981ux7d04ux7d71ux8a08ux91cfux306eux30b0ux30e9ux30d5ux5316}{%
\section{要約統計量のグラフ化}\label{ux8981ux7d04ux7d71ux8a08ux91cfux306eux30b0ux30e9ux30d5ux5316}}
...
\caption{Google Colab, Theme: dark}\label{fig:unnamed-chunk-141}
\end{figure}
...
\caption{Upload notebook file}\label{fig:unnamed-chunk-142}
\end{figure}
...
\caption{Upload from GitHub}\label{fig:unnamed-chunk-143}
\end{figure}
...
\caption{Warning dialog}\label{fig:unnamed-chunk-144}
\end{figure}
...
\caption{Initial View}\label{fig:unnamed-chunk-146}
\end{figure}
...
\caption{Packages Manager}\label{fig:unnamed-chunk-147}
\end{figure}
...
\caption{Install Dialog}\label{fig:unnamed-chunk-148}
\end{figure}
...
\caption{RStudio Desktop, Windows}\label{fig:unnamed-chunk-156}
\end{figure}
...
\caption{RStudio Pane Layout, Windows}\label{fig:unnamed-chunk-157}
\end{figure}
...
\caption{R Notebook file}\label{fig:unnamed-chunk-158}
\end{figure}
...
\caption{R Notebook saved file}\label{fig:unnamed-chunk-159}
\end{figure}
...
\caption{R Notebook insert chunk}\label{fig:unnamed-chunk-160}
\end{figure}
...
\caption{R Notebook first code}\label{fig:unnamed-chunk-161}
\end{figure}
...
\caption{R Notebook run code}\label{fig:unnamed-chunk-162}
\end{figure}
...
\caption{R Notebook option}\label{fig:unnamed-chunk-163}
\end{figure}
...
\caption{RStudio Cloud, beta}\label{fig:unnamed-chunk-164}
\end{figure}
...
\caption{Exploratory Public}\label{fig:unnamed-chunk-165}
\end{figure}
