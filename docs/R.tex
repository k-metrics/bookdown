...
\caption{Install Dialog}\label{fig:unnamed-chunk-142}
\end{figure}
...
\caption{RStudio Desktop, Windows}\label{fig:unnamed-chunk-150}
\end{figure}
...
\caption{RStudio Pane Layout, Windows}\label{fig:unnamed-chunk-151}
\end{figure}
...
\caption{R Notebook file}\label{fig:unnamed-chunk-152}
\end{figure}
...
\caption{R Notebook saved file}\label{fig:unnamed-chunk-153}
\end{figure}
...
\caption{R Notebook insert chunk}\label{fig:unnamed-chunk-154}
\end{figure}
...
\caption{R Notebook first code}\label{fig:unnamed-chunk-155}
\end{figure}
...
\caption{R Notebook run code}\label{fig:unnamed-chunk-156}
\end{figure}
...
\caption{R Notebook option}\label{fig:unnamed-chunk-157}
\end{figure}
