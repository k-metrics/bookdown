...
\hypertarget{ux9591ux8a71-ux30d1ux30c3ux30b1ux30fcux30b8ux56dbux65b9ux5c71ux8a71}{%
\subsubsection*{【閑話】 パッケージ四方山話}\label{ux9591ux8a71-ux30d1ux30c3ux30b1ux30fcux30b8ux56dbux65b9ux5c71ux8a71}}
\addcontentsline{toc}{subsubsection}{【閑話】 パッケージ四方山話}
...
\hypertarget{ux9591ux8a71-ux30e2ux30fcux30e1ux30f3ux30c8}{%
\subsubsection*{閑話 モーメント}\label{ux9591ux8a71-ux30e2ux30fcux30e1ux30f3ux30c8}}
\addcontentsline{toc}{subsubsection}{閑話 モーメント}
...
\begin{rmdnote}
\textbf{【コラム】英字？ギリシャ文字？}\\
　統計の書籍では様々な統計量を英字で表記する場合とギリシャ文字で表記する場合があり混乱しやすいのですが、英字（アルファベット）で表記されている場合は標本統計量（単に統計量という場合も）、ギリシャ文字で表記されている場合は母数の推定統計量（単に推定量という場合も）を意味しています。推定統計量を表記する場合、推定であることを意味するハット（ \(\hat{}\) ）という記号をつけて表記します（例えば、平均値は\(\hat{\mu}\)、分散は\(\hat{\sigma}^2\)と表記）。ハット（ \(\hat{}\) ）を省略している書籍や資料も散見されますので混乱しないように注意してください。詳しくは『統計的方法のしくみ』\citep{ToukeitekiHouhounoSikumi:jbook}の「3. 母数と統計量の区別」を参照してください。 \end{rmdnote}
...
\caption{Google Colab, Theme: dark}\label{fig:unnamed-chunk-78}
\end{figure}
...
\caption{Upload notebook file}\label{fig:unnamed-chunk-79}
\end{figure}
...
\caption{Upload from GitHub}\label{fig:unnamed-chunk-80}
\end{figure}
...
\caption{Warning dialog}\label{fig:unnamed-chunk-81}
\end{figure}
...
\caption{RStudio Cloud, beta}\label{fig:unnamed-chunk-82}
\end{figure}
...
\caption{Initial View}\label{fig:unnamed-chunk-83}
\end{figure}
...
\caption{Packages Manager}\label{fig:unnamed-chunk-84}
\end{figure}
...
\caption{Install Dialog}\label{fig:unnamed-chunk-85}
\end{figure}
...
\caption{RStudio Desktop, Windows}\label{fig:unnamed-chunk-93}
\end{figure}
...
\caption{RStudio Pane Layout, Windows}\label{fig:unnamed-chunk-94}
\end{figure}
...
\caption{R Notebook file}\label{fig:unnamed-chunk-95}
\end{figure}
...
\caption{R Notebook saved file}\label{fig:unnamed-chunk-96}
\end{figure}
...
\caption{R Notebook insert chunk}\label{fig:unnamed-chunk-97}
\end{figure}
...
\caption{R Notebook first code}\label{fig:unnamed-chunk-98}
\end{figure}
...
\caption{R Notebook run code}\label{fig:unnamed-chunk-99}
\end{figure}
...
\caption{R Notebook option}\label{fig:unnamed-chunk-100}
\end{figure}
...
\caption{RStudio Cloud, beta}\label{fig:unnamed-chunk-101}
\end{figure}
...
\caption{Exploratory Public}\label{fig:unnamed-chunk-102}
\end{figure}
