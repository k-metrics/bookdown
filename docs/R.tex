...
関数名 & モノフォントで()付き\footnote{3} & \texttt{print()} \\
...
{\centering \includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-32-1} 
...
{\centering \includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-34-1} 
...
{\centering \includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-36-1} 
...
{\centering \includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-38-1} 
...
{\centering \includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-40-1} 
...
{\centering \includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-42-1} 
