...
{\centering \includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-88-1} 

}

\caption{箱ひげ図}\label{fig:unnamed-chunk-88}
\end{figure}
...
\begin{center}\includegraphics[width=0.9\linewidth,]{R_files/figure-latex/unnamed-chunk-89-1} \end{center}
...
\caption{Google Colab, Theme: dark}\label{fig:unnamed-chunk-151}
\end{figure}
...
\caption{Upload notebook file}\label{fig:unnamed-chunk-152}
\end{figure}
...
\caption{Upload from GitHub}\label{fig:unnamed-chunk-153}
\end{figure}
...
\caption{Warning dialog}\label{fig:unnamed-chunk-154}
\end{figure}
...
\caption{RStudio Cloud, beta}\label{fig:unnamed-chunk-155}
\end{figure}
...
\caption{Initial View}\label{fig:unnamed-chunk-156}
\end{figure}
...
\caption{Packages Manager}\label{fig:unnamed-chunk-157}
\end{figure}
...
\caption{Install Dialog}\label{fig:unnamed-chunk-158}
\end{figure}
...
\caption{RStudio Desktop, Windows}\label{fig:unnamed-chunk-166}
\end{figure}
...
\caption{RStudio Pane Layout, Windows}\label{fig:unnamed-chunk-167}
\end{figure}
...
\caption{R Notebook file}\label{fig:unnamed-chunk-168}
\end{figure}
...
\caption{R Notebook saved file}\label{fig:unnamed-chunk-169}
\end{figure}
...
\caption{R Notebook insert chunk}\label{fig:unnamed-chunk-170}
\end{figure}
...
\caption{R Notebook first code}\label{fig:unnamed-chunk-171}
\end{figure}
...
\caption{R Notebook run code}\label{fig:unnamed-chunk-172}
\end{figure}
...
\caption{R Notebook option}\label{fig:unnamed-chunk-173}
\end{figure}
...
\caption{RStudio Cloud, beta}\label{fig:unnamed-chunk-174}
\end{figure}
...
\caption{Exploratory Public}\label{fig:unnamed-chunk-175}
\end{figure}
