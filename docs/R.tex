...
関数（オブジェクト） & モノフォントで()付き表記 & \texttt{print()} \\
...
\caption{Google Colab での実行例}\label{fig:unnamed-chunk-12}
\end{figure}
...
\caption{Google Colab, Theme: dark}\label{fig:unnamed-chunk-33}
\end{figure}
...
\caption{Upload notebook file}\label{fig:unnamed-chunk-34}
\end{figure}
...
\caption{Upload from GitHub}\label{fig:unnamed-chunk-35}
\end{figure}
...
\caption{Warning dialog}\label{fig:unnamed-chunk-36}
\end{figure}
...
\caption{RStudio Cloud, beta}\label{fig:unnamed-chunk-37}
\end{figure}
...
\caption{Initial View}\label{fig:unnamed-chunk-38}
\end{figure}
...
\caption{Packages Manager}\label{fig:unnamed-chunk-39}
\end{figure}
...
\caption{Install Dialog}\label{fig:unnamed-chunk-40}
\end{figure}
...
\caption{RStudio Desktop, Windows}\label{fig:unnamed-chunk-48}
\end{figure}
...
\caption{RStudio Pane Layout, Windows}\label{fig:unnamed-chunk-49}
\end{figure}
...
\caption{R Notebook file}\label{fig:unnamed-chunk-50}
\end{figure}
...
\caption{R Notebook saved file}\label{fig:unnamed-chunk-51}
\end{figure}
...
\caption{R Notebook insert chunk}\label{fig:unnamed-chunk-52}
\end{figure}
...
\caption{R Notebook first code}\label{fig:unnamed-chunk-53}
\end{figure}
...
\caption{R Notebook run code}\label{fig:unnamed-chunk-54}
\end{figure}
...
\caption{R Notebook option}\label{fig:unnamed-chunk-55}
\end{figure}
...
\caption{RStudio Cloud, beta}\label{fig:unnamed-chunk-56}
\end{figure}
...
\caption{Exploratory Public}\label{fig:unnamed-chunk-57}
\end{figure}
