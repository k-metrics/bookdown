...
\midrule
\endhead
ハイパーリンク & 脚注にURL表記（PDFのみ） & CRAN\textsuperscript{No.} \\
...
{\centering \includegraphics[width=0.85\linewidth,]{R_files/figure-latex/unnamed-chunk-5-1} 
...
{\centering \subfloat[花弁\label{fig:unnamed-chunk-6-1}]{\includegraphics[width=0.4\linewidth,]{R_files/figure-latex/unnamed-chunk-6-1} }\subfloat[萼片\label{fig:unnamed-chunk-6-2}]{\includegraphics[width=0.4\linewidth,]{R_files/figure-latex/unnamed-chunk-6-2} }

}

\caption{幅と長さの関係}\label{fig:unnamed-chunk-6}
\end{figure}
...
{\centering \subfloat[花弁の回帰関係\label{fig:unnamed-chunk-8-1}]{\includegraphics[width=0.4\linewidth,]{R_files/figure-latex/unnamed-chunk-8-1} }\subfloat[萼片の回帰関係\label{fig:unnamed-chunk-8-2}]{\includegraphics[width=0.4\linewidth,]{R_files/figure-latex/unnamed-chunk-8-2} }
...
\tightlist
\item
  \textbf{\texttt{readr}} - 様々なテキスト形式テーブルを読み込むためのパッケージ
\item
  \textbf{\texttt{readxl}} - Microsoft Excelのファイルを読み込むためのパッケージ
\item
  \textbf{\texttt{rvest}} - Webスクレイピングのためのパッケージ
\item
  \textbf{\texttt{googlesheets4}} - Google API v4 経由でスプレッドシートを読み込むためのパッケージ
\item
  \textbf{\texttt{DBI}} - SQL系の各種データベースと接続するためのパッケージ
\end{itemize}
...
\tightlist
\item
  \textbf{\texttt{tidyr}} - Tidy Dataの作成を強力にサポートしてくれるパッケージ
\item
  \textbf{\texttt{zoo}} - 時系列（TS）データを効率よく扱うためのパッケージ
\end{itemize}
...
\tightlist
\item
  \textbf{\texttt{ggplot2}} - 統一された文法で描画が行えるパッケージ
\item
  \textbf{\texttt{htmlwidgets}} - JavaScriptのウィジェットを利用できるパッケージ
\end{itemize}
...
\tightlist
\item
  \textbf{\texttt{dplyr}} - Tidy Dataを様々な方法で操作するためのパッケージ
\item
  \textbf{\texttt{stringr}} - 文字列処理をするためのパッケージ
\item
  \textbf{\texttt{forcats}} - 因子型を操作するためのパッケージ
\item
  \textbf{\texttt{lubridate}} - 日付データを簡単に変換するためのパッケージ
\end{itemize}
...
\tightlist
\item
  \textbf{\texttt{broom}} - 各種モデリング結果を整然データにするためのパッケージ
\item
  \textbf{\texttt{tidymodels}} - 機械学習を中心としたモデリングフレームワーク
\end{itemize}
...
\tightlist
\item
  \textbf{\texttt{knitr}} - \textbf{R}のコードと実行結果をPDFやHTMLなどに埋め込むためのパッケージ
\item
  \textbf{`rmarkdown``} - マークダウン書式を用いてレポートを作成するためのパッケージ
\item
  \textbf{\texttt{bookdown}} - 書籍や長いドキュメンを作成するためのパッケージ
\item
  \textbf{\texttt{shiny}} - インタラクティブなWebアプリケーションを作成するためのパッケージ
\end{itemize}
...
\textbf{\texttt{magrittr}}パッケージのパイプ演算子（\texttt{\%\textgreater{}\%”}）や\textbf{\texttt{purrr}}パッケージによる反復処理が、分析を円滑に回すハブ・スポーク的な役目を果たします。
...
\caption{Rcmdr, Ubuntu}\label{fig:unnamed-chunk-14}
\end{figure}
...
\caption{RStudio Desktop, Windows}\label{fig:unnamed-chunk-16}
\end{figure}
...
\caption{RStudio Server, Docker}\label{fig:unnamed-chunk-17}
\end{figure}
...
\caption{Google Colab, Theme: dark}\label{fig:unnamed-chunk-64}
\end{figure}
...
\caption{Upload notebook file}\label{fig:unnamed-chunk-65}
\end{figure}
...
\caption{Upload from GitHub}\label{fig:unnamed-chunk-66}
\end{figure}
...
\caption{Warning dialog}\label{fig:unnamed-chunk-67}
\end{figure}
...
\caption{RStudio Cloud, beta}\label{fig:unnamed-chunk-68}
\end{figure}
...
\caption{Initial View}\label{fig:unnamed-chunk-69}
\end{figure}
...
\caption{Packages Manager}\label{fig:unnamed-chunk-70}
\end{figure}
...
\caption{Install Dialog}\label{fig:unnamed-chunk-71}
\end{figure}
...
\caption{RStudio Desktop, Windows}\label{fig:unnamed-chunk-79}
\end{figure}
...
\caption{RStudio Pane Layout, Windows}\label{fig:unnamed-chunk-80}
\end{figure}
...
\caption{R Notebook file}\label{fig:unnamed-chunk-81}
\end{figure}
...
\caption{R Notebook saved file}\label{fig:unnamed-chunk-82}
\end{figure}
...
\caption{R Notebook insert chunk}\label{fig:unnamed-chunk-83}
\end{figure}
...
\caption{R Notebook first code}\label{fig:unnamed-chunk-84}
\end{figure}
...
\caption{R Notebook run code}\label{fig:unnamed-chunk-85}
\end{figure}
...
\caption{R Notebook option}\label{fig:unnamed-chunk-86}
\end{figure}
...
\caption{RStudio Cloud, beta}\label{fig:unnamed-chunk-87}
\end{figure}
...
\caption{Exploratory Public}\label{fig:unnamed-chunk-88}
\end{figure}
