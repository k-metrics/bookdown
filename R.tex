...
　\\
　\href{https://www.juse-p.co.jp/products/view/442}{『データ指向のソフトウェア品質マネジメント』 } は、日本のソフトウェア品質管理におけるデータドリブン管理の必要性とデータドリブン管理に必要な知識を解説している数少ない書籍です。著者の一人である小池氏が主催している \href{https://sites.google.com/site/kantometrics/home}{データ分析勉強会 } では、メトリクス分析に興味をもつ有志がデータドリブン管理を実践するために様々な分析知識や手法を学んでいます。\\
　\\
...
{\centering \includegraphics[width=0.95\linewidth]{https://github.com/hadley/r4ds/blob/master/diagrams/data-science-explore.png?raw=true} 

}

\caption{Data Science Workflow, CC BY-NC-ND 3.0 US, Hadley Wickham}\label{fig:unnamed-chunk-2}
\end{figure}
...
　\\
\textbf{Communicate}\\
　分析結果を他人に伝えるためのプロセスです。結果を他人に伝えるだけでは不十分で \href{}{再現可能性（Reproducible research） } が伴っていることも求められます。
　
　\href{http://www.igaku-shoin.co.jp/paperDetail.do?id=PA03357_03}{3つの再現可能性 }
...
\href{https://mybinder.org/v2/gh/k-metrics/learnr/master?urlpath=rstudio}{\includegraphics{https://mybinder.org/badge_logo.svg} Run Tutorial on binder}
...
\href{https://mybinder.org/v2/gh/k-metrics/learnr/master?urlpath=rstudio}{\includegraphics{https://mybinder.org/badge_logo.svg} Lunch RStudio on binder}
...
\tightlist
\item
  右下のエリアに表示されている \texttt{.Rmd} ファイルをクリックします
\item
  左上のエリアに \texttt{.Rmd} ファイルが開きます
\item
  ファイルが表示されているエリアの上部にある \textbf{\texttt{Run\ Document}} をクリックします
\item
  ダイアログが表示された場合は \textbf{\texttt{Try\ again}} ボタンをクリックします
\item
  チュートリアルウィンドウが開きます
\end{enumerate}

　\\
　チュートリアルでは下図のようなコードが表示されます。表示されたコードを実行するには \textbf{\texttt{Run\ Code}} をクリックしてください。\textbf{\texttt{Start\ Over}} をクリックすると実行結果をリセットすることができます。また、コードの修正や追記も可能です。\\
　
...
\caption{Google Colab での実行例}\label{fig:unnamed-chunk-3}
\end{figure}
...
\subsection{基本的な演算（Basic Operations）}\label{ux57faux672cux7684ux306aux6f14ux7b97basic-operations}}
...
\subsubsection{算術演算の基本}\label{ux7b97ux8853ux6f14ux7b97ux306eux57faux672c}}
...
\subsubsection{代入演算の基本}\label{ux4ee3ux5165ux6f14ux7b97ux306eux57faux672c}}
...
\subsubsection{変数演算の基本}\label{ux5909ux6570ux6f14ux7b97ux306eux57faux672c}}
...
\subsection{予約語（Reserved word）}\label{ux4e88ux7d04ux8a9ereserved-word}}
...
\subsection{変数（Variables）}\label{ux5909ux6570variables}}
...
\subsubsection{データ型}\label{ux30c7ux30fcux30bfux578b}}
...
\subsubsection{変数型}\label{ux5909ux6570ux578b}}
...
\subsection{定数（Constant）}\label{ux5b9aux6570constant}}
...
\subsubsection{\texorpdfstring{\texttt{NA} の型}{NA の型}}\label{na-ux306eux578b}}
...
\subsection{参照・アクセス（Access Operators）}\label{ux53c2ux7167ux30a2ux30afux30bbux30b9access-operators}}
...
\subsubsection{\texorpdfstring{\texttt{{[}} 演算子}{{[} 演算子}}\label{ux6f14ux7b97ux5b50}}
...
\subsection{検査・変換}\label{ux691cux67fbux5909ux63db}}
...
\subsection{演算子（Operators）}\label{ux6f14ux7b97ux5b50operators}}
...
\subsubsection{比較演算子 Logical Operations}\label{ux6bd4ux8f03ux6f14ux7b97ux5b50-logical-operations}}
...
\subsubsection{論理演算子 Boolean Operations}\label{ux8ad6ux7406ux6f14ux7b97ux5b50-boolean-operations}}
...
\subsubsection{特殊演算子}\label{ux7279ux6b8aux6f14ux7b97ux5b50}}
...
\subsection{制御文}\label{ux5236ux5fa1ux6587}}
...
\subsubsection{条件分岐}\label{ux6761ux4ef6ux5206ux5c90}}
...
\subsubsection{繰り返し}\label{ux7e70ux308aux8fd4ux3057}}
...
\subsection{pdftools}\label{pdftools}}
...
\section{Environments 2}\label{environments-2}}
...
\subsubsection{Login Google}\label{login-google}}
...
\subsubsection{Open Google Colab}\label{open-google-colab}}
...
\caption{Google Colab, Theme: dark}\label{fig:unnamed-chunk-24}
\end{figure}
...
\subsubsection{Upload Template}\label{upload-template}}
...
\caption{Upload notebook file}\label{fig:unnamed-chunk-25}
\end{figure}
...
\caption{Upload from GitHub}\label{fig:unnamed-chunk-26}
\end{figure}
...
\subsubsection{Run R code}\label{run-r-code}}
...
\caption{Warning dialog}\label{fig:unnamed-chunk-27}
\end{figure}
...
\subsubsection{Save File}\label{save-file}}
...
\caption{RStudio Cloud, beta}\label{fig:unnamed-chunk-28}
\end{figure}
...
\caption{Initial View}\label{fig:unnamed-chunk-29}
\end{figure}
...
\caption{Packages Manager}\label{fig:unnamed-chunk-30}
\end{figure}
...
\caption{Install Dialog}\label{fig:unnamed-chunk-31}
\end{figure}
...
\section{Install R/RStudio}\label{install-rrstudio}}
...
\subsubsection{macOS (OS X)}\label{macos-os-x}}
...
\subsection{Install RStudio Desktop}\label{install-rstudio-desktop}}
...
　\\
\includegraphics{./fig/RStudio_Desktop.png}
...
\subsubsection{Linux環境の場合}\label{linuxux74b0ux5883ux306eux5834ux5408}}
...
\subsubsection{Git Client}\label{git-client}}
...
\subsection{Setup RStudio Sever with Docker}\label{setup-rstudio-sever-with-docker}}
...
\subsubsection{Enable Hyper-V (Windows Only)}\label{enable-hyper-v-windows-only}}
...
\subsubsection{Download and Install Docker Desktop}\label{download-and-install-docker-desktop}}
...
\subsubsection{Download Docker Image}\label{download-docker-image}}
...
\subsubsection{Run Container}\label{run-container}}
...
\caption{RStudio Desktop, Windows}\label{fig:unnamed-chunk-39}
\end{figure}
...
\caption{RStudio Pane Layout, Windows}\label{fig:unnamed-chunk-40}
\end{figure}
...
\subsection{Writing R code}\label{writing-r-code}}
...
\caption{R Notebook file}\label{fig:unnamed-chunk-41}
\end{figure}
...
\caption{R Notebook saved file}\label{fig:unnamed-chunk-42}
\end{figure}
...
\caption{R Notebook insert chunk}\label{fig:unnamed-chunk-43}
\end{figure}
...
\caption{R Notebook first code}\label{fig:unnamed-chunk-44}
\end{figure}
...
\caption{R Notebook run code}\label{fig:unnamed-chunk-45}
\end{figure}
...
\caption{R Notebook option}\label{fig:unnamed-chunk-46}
\end{figure}
...
\subsubsection{R Markdown}\label{r-markdown-1}}
...
\subsubsection{Spelling}\label{spelling}}
...
\hypertarget{gitsvn}{%
\subsubsection{Git/SVN}\label{gitsvn}}
...
\section{Cloud IDE}\label{cloud-ide}}

　開発環境のクラウドサービス化も進んでいます。

\hypertarget{rstudio-cloud-ga}{%
\subsection{RStudio Cloud GA}\label{rstudio-cloud-ga}}
...
\caption{RStudio Cloud, beta}\label{fig:unnamed-chunk-47}
\end{figure}
...
\caption{Exploratory Public}\label{fig:unnamed-chunk-48}
\end{figure}
