...
## 想定読者 {.unnumbered}
本書は基本的なコンピュータの知識と基礎的な統計の知識を有している読者を想定しています。本書では [R](https://cran.r-project.org/) の分析環境の構築に関する詳細な解説は行いませんので、分析環境の構築に不安がある読者は [Google Colaboratory](https://colab.research.google.com/notebook#create=true&language=r) を利用してみてください。
